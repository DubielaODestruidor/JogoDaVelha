...
public class MenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn = (Button)findViewById(R.id.startGameBt);
    ...
    private void setAdapter() {
        recyclerAdapter adapter = new recyclerAdapter(lorePieces);
    ...
    private void setLoreInfo() {
        lorePieces.add(new LorePiece("No mundo de Curitiberra, todos os animais viviam em paz por milênios, pastando, comendo moscas veganas (os sapos inventaram moscas artificiais para acabar com a chacina) e pastando grama trangênica gigante. Até que um dia, um gato chamado Gato, que era um gato muito gato, resolveu que queria ser o rei dos gatos. E assim, ele começou a matar todos os outros gatos, até que só restou ele. E ele se tornou o rei dos gatos. E ele era muito gato. Mas tudo mudou quando a Nação das Capivaras atacou. O rei gato chamado Gato que era muito gato foi tirado do trono e os sapos postos sob a tirania das capivaras. Assim começa a história de Sapos & Capivaras..."));
        lorePieces.add(new LorePiece("According to all known laws of aviation, there is no way a bee should be able to fly.\n" +
